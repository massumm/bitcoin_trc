...
<div class="container d-flex flex-column align-items-center justify-content-center min-vh-100">
    <!-- Header -->
    <!-- Referral Code -->
    <p class="text-muted">My invitation code</p>
    ...
    <p class="text-danger small">Long press to save the QR code</p>

    <!-- Share Link -->
    <div class="card p-3 shadow-sm w-100" style="max-width: 350px;">
        <div class="d-flex justify-content-between align-items-center">
            <p class="text-muted m-0">Share link</p>
            <button class="btn btn-link text-danger p-0" onclick="copyLink()">Copy</button>
        </div>
